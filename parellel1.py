...
def main():
    ...
    pobj = multiprocessing.Pool() # multiprocessing module madhalya Pool navacha class cha object create kela.

    Result = pobj.map(Square, Data) # FMR madhala map ahe ha map.
